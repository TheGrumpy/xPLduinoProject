...
namespace xPLduinoManager
{
	...
	public class MenuTextEditorScenario
	{
		...
		public MenuTextEditorScenario (int _Column, int _Id, int _IdParent, bool _Active,  string _Name, string _Text, string _Tooltip)
		{
