...
uint8_t I2C16::write(uint8_t address, uint8_t registerAddress)
{
  returnStatus = 0;
  returnStatus = start();
...
uint8_t I2C16::write(uint8_t address, uint8_t registerAddress, uint8_t data)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
uint8_t I2C16::write(uint8_t address, uint8_t registerAddress, char *data)
{
...
uint8_t I2C16::write(uint8_t address, uint8_t registerAddress, uint8_t *data, uint8_t numberBytes)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
// add 16bits adress mode

uint8_t I2C16::write16(uint8_t address, uint16_t registerAddress)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
uint8_t I2C16::write16(uint8_t address, uint16_t registerAddress, uint8_t data)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
uint8_t I2C16::write16(uint8_t address, uint16_t registerAddress, char *data)
{
  uint8_t bufferLength = strlen(data);
  returnStatus = 0;
...
uint8_t I2C16::write16(uint8_t address, uint16_t registerAddress, uint8_t *data, uint8_t numberBytes)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
// add read 16bits adress mode


uint8_t I2C16::read16(uint8_t address, uint16_t registerAddress, uint8_t numberBytes)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
uint8_t I2C16::read16(uint8_t address, uint16_t registerAddress, uint8_t numberBytes, uint8_t *dataBuffer)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
// end of add read 16 bits address mode
...
uint8_t I2C16::read(uint8_t address, uint8_t registerAddress, uint8_t numberBytes)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
uint8_t I2C16::read(uint8_t address, uint8_t registerAddress, uint8_t numberBytes, uint8_t *dataBuffer)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
