...
*/
#ifndef _RCSwitch_mod_h
#define _RCSwitch_mod_h
...
#define IN0_PORT PORTA        /* PORTx - register for button output */
#define IN0_PIN  PINA         /* PINx - register for button input */
#define IN0_BIT  PINA1          /* bit for button input/output */
...
class RCSwitch {
  ...
  public:
    ...
    //SVE
        void enableReceivePCINT(int interrupt);
    // ---
    	void enableReceive();
